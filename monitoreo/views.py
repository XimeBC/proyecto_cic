    ...
    if request.method == "POST":
        ...
        if formulario.is_valid():
            if (request.POST['temperatura'] < '39') and (request.POST['oxigenacion'] > '85'):
                ...
                control= Restringidos(nombre_usuario=usuario.nombre_usuario, estado_condicion=1 ,tipo_prueba=0,fecha_prueba='2000-01-01',fecha_sintomas=request.POST['fecha_hora_registro'],user_id=user.id)
                control.save() 
                usuario.estado = 0
                usuario.save()
